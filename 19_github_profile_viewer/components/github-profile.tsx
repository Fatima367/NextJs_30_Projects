...
export default function GithubProfile() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-200 py-8">
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-2xl bg-white
      ring-2 ring-white ring-offset-2 ring-offset-slate-200
      ">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600 text-base">
            ...
            repositories, search like: xyx321
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4">
            <Input
              ...
              className="flex-1 border rounded-md p-2 shadow-md"
            />
            <Button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-slate-800 text-white rounded-md shadow-lg font-bold"
            >
            ...
            <div className="grid md:grid-cols-[120px_1fr] gap-6">
              ...
              <div className="grid gap-2">
                <div className="flex items-center gap-2">
                  <h2 className="text-2xl font-bold text-blue-900">{userProfile.login}</h2>
                  <Link
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
                {userRepos.map((repo) => (
                  ...
                  >
                    <CardHeader>
                      <div className="flex items-center gap-2">
                        <RecycleIcon className="w-6 h-6 text-blue-500" />
                        <CardTitle>
                          <Link
                            href={repo.html_url}
                            target="_blank"
                    ...
                    <CardFooter className="flex items-center justify-between">
                      ...
                      <Link
                        href={repo.html_url}
                        target="_blank"
                        className="text-blue-900 hover:underline underline"
                        prefetch={false}
                      >
                        View on GitHub
                      </Link>
